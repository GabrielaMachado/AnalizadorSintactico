 ...
 * @author dani0
 */
public class GramaticaCuerpo implements Gramatica {
...
//Sentencia a retornar....
        ...
        GramaticaListaMiembro gramaticaListaMiembro = new GramaticaListaMiembro();
        ...
        listaMiembros = (ListaMiembros) gramaticaListaMiembro.analizar(arrayLexemas);
        //tipo de dato.....
        if (listaMiembros != null) {
            cuerpo.setMiembros(listaMiembros);
            posicion++;
            posA = posicion;
            return cuerpo;
        } else {
